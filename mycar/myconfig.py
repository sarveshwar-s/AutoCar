...
TELEMETRY_DEFAULT_INPUTS = 'pilot/angle,pilot/throttle,pilot/speed,recording'
TELEMETRY_DEFAULT_TYPES = 'float,float,float'
# 
# # PERF MONITOR
# HAVE_PERFMON = False
# 
...
DONKEY_GYM = True
DONKEY_SIM_PATH = "C:/Users/sarve/Documents/DonkeySimWin/DonkeySimWin/donkey_sim.exe" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
...
GYM_CONF = { "body_style" : "donkey", "body_rgb" : (128, 128, 128), "car_name" : "Bolt", "font_size" : 100} # body style(donkey|bare|car01) body rgb 0-255
